				...
				<form class="validation-form" novalidate name="joinform"
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							<label for="pass">비밀번호</label> <input type="password" name="pass"
								class="form-control" id="pass" placeholder="아이디" value=""
								required>
							<div class="invalid-feedback">비밀번호을 입력해주세요.</div>
						</div>
						<div class="col-md-6 mb-3">
							<label for="pass2">비밀번호확인</label> <input type="password"
								name="pass2" class="form-control" id="pass2" placeholder=""
								value="" required>
					...
					<div class="row">
						...
						<div class="col-md-6 mb-3">
							<label for="gender">여자</label> <input type="radio" name="gender"
								id="gender" placeholder="" value="2" required>
					...
					<div class="mb-3">
						<label for="tel">전화번호</label> <input type="text" name="tel"
							class="form-control" id="tel" placeholder="전화번호" required>
